...
(function () {
  ...
  if (Object.keys(incomingUtms).length) {
    // Persist for the session so all clicks pick them up
    try {
  ...
  document.querySelectorAll('[data-track]').forEach((el) => {
    el.addEventListener('click', function (e) {
      ...
      // For outbound links — append UTMs in-flight
  ...
  // ---------------------------------------------
  // 6. Time-on-page heartbeat (helps measure
  //    real engagement, not just bounces)
  // ---------------------------------------------
  let timeOnPage = 0;
  const heartbeats = [10, 30, 60, 120, 300]; // seconds
  ...
  // ---------------------------------------------
  // 7. Reveal-on-scroll for sections (lightweight)
  // ---------------------------------------------
  ...
  // ---------------------------------------------
  // 8. Debug toggle: ?debug=1 in URL enables console logs
  // ---------------------------------------------
